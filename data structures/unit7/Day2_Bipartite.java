...
public class Day2_Bipartite {
     ...
     */
    public Day2_Bipartite(EdgeWeightedGraph G) {
        marked = new boolean[G.V()];
        id = new int[G.V()];
        size = new int[G.V()];
        for (int v = 0; v < G.V(); v++) {
    ...
    private void dfs(Graph G, int v) {
        ...
        for (int w : G.adj(v)) {
            if (!marked[w]) {
                color[w] = (color[v] == COLOR_ONE) ? COLOR_TWO : COLOR_ONE;
                dfs(G, w);
            }
    ...
    public static void main(String[] args) {
        ...
        Day2_Bipartite cc = new Day2_Bipartite(G);
        ...
        System.out.println("Bipartite: " + cc.bipartite);
    }
}
